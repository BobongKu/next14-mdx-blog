...
const PostCard = ({ post }: Props) => {
  return (
    <TransitionLink href={post.url}>
      <li className='z-0 group flex h-full flex-col gap-3 overflow-hidden rounded-md border shadow-md transition hover:shadow-xl dark:border-slate-700 dark:hover:border-white'>
